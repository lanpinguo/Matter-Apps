...
// Use this macro to check if the server side of the Wi-Fi Network Diagnostics
// cluster is included
...
// Use this macro to check if the server side of the Scenes Management cluster
// is included
...
#define MATTER_CLUSTER_SCENE_NAME_SUPPORT                                      \
  (0x0000 & MATTER_CLUSTER_SCENE_NAME_SUPPORT_MASK)
// Scenes FeatureMap Table Size feature used for the
// SCENES_MANAGEMENT_TABLE_SIZE define App cluster specs 1.4.4.2
#define MATTER_CLUSTER_TABLE_SIZE_SUPPORT_MASK 0x0001
#define MATTER_CLUSTER_TABLE_SIZE_SUPPORT                                      \
  (0x0000 & MATTER_CLUSTER_TABLE_SIZE_SUPPORT_MASK)
