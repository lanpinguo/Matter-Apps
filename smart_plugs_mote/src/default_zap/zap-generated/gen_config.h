...
#define MATTER_DM_GROUPS_CLUSTER_SERVER_ENDPOINT_COUNT (8)
#define MATTER_DM_ON_OFF_CLUSTER_SERVER_ENDPOINT_COUNT (8)
#define MATTER_DM_LEVEL_CONTROL_CLUSTER_SERVER_ENDPOINT_COUNT (1)
#define MATTER_DM_PWM_CLUSTER_SERVER_ENDPOINT_COUNT (0)
#define MATTER_DM_DESCRIPTOR_CLUSTER_SERVER_ENDPOINT_COUNT (9)
