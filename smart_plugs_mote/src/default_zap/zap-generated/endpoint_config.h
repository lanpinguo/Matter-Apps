...
#define GENERATED_ATTRIBUTES                                                   \
  {                                                                            \
      ...
      {ZAP_SIMPLE_DEFAULT(0), 0x00004002, 2, ZAP_TYPE(INT16U),                 \
       ZAP_ATTRIBUTE_MASK(WRITABLE)}, /* OffWaitTime */                        \
      {ZAP_MIN_MAX_DEFAULTS_INDEX(7), 0x00004003, 1, ZAP_TYPE(ENUM8),          \
       ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |            \
           ZAP_ATTRIBUTE_MASK(NULLABLE)}, /* StartUpOnOff */                   \
      {ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),               \
       0}, /* FeatureMap */                                                    \
      ...
      {ZAP_SIMPLE_DEFAULT(0), 0x00004002, 2, ZAP_TYPE(INT16U),                 \
       ZAP_ATTRIBUTE_MASK(WRITABLE)}, /* OffWaitTime */                        \
      {ZAP_MIN_MAX_DEFAULTS_INDEX(8), 0x00004003, 1, ZAP_TYPE(ENUM8),          \
       ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |            \
           ZAP_ATTRIBUTE_MASK(NULLABLE)}, /* StartUpOnOff */                   \
      {ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),               \
       0}, /* FeatureMap */                                                    \
...
#define GENERATED_ENDPOINT_TYPES                                               \
  {                                                                            \
      {ZAP_CLUSTER_INDEX(0), 14, 84}, {ZAP_CLUSTER_INDEX(14), 5, 50},          \
      {ZAP_CLUSTER_INDEX(19), 4, 29}, {ZAP_CLUSTER_INDEX(23), 4, 29},          \
      {ZAP_CLUSTER_INDEX(27), 4, 29}, {ZAP_CLUSTER_INDEX(31), 4, 29},          \
      {ZAP_CLUSTER_INDEX(35), 4, 29}, {ZAP_CLUSTER_INDEX(39), 4, 29},          \
      {ZAP_CLUSTER_INDEX(43), 4, 29},                                          \
  }
...
#define FIXED_DEVICE_TYPES                                                     \
  {{0x00000016, 1}, {0x0000010A, 2}, {0x0000010A, 1},                          \
   {0x0000010A, 1}, {0x0000010A, 1}, {0x0000010A, 1},                          \
   {0x0000010A, 1}, {0x0000010A, 1}, {0x0000010A, 1}}

// Array of device type offsets
#define FIXED_DEVICE_TYPE_OFFSETS {0, 1, 2, 3, 4, 5, 6, 7, 8}

// Array of device type lengths
#define FIXED_DEVICE_TYPE_LENGTHS {1, 1, 1, 1, 1, 1, 1, 1, 1}

// Array of endpoint types supported on each endpoint
#define FIXED_ENDPOINT_TYPES {0, 1, 2, 3, 4, 5, 6, 7, 8}
