...
#define NUMBER_OF_BUTTONS_MODE      2
...
#define CALL_IN_BUTTON DK_BTN3
#define CALL_IN__BUTTON_MASK DK_BTN3_MSK

#else
#define LOCK_BUTTON DK_BTN2
#define LOCK_BUTTON_MASK DK_BTN2_MSK
#define THREAD_WIFI_SWITCH_BUTTON DK_BTN3
#define THREAD_WIFI_SWITCH_BUTTON_MASK DK_BTN3_MSK
